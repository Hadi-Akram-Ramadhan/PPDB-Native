...
if (isset($_POST['daftar'])) {
    ...
    $sql = "INSERT INTO config (nik, nama, asal_sekolah, tanggal_lahir, no_telp, jenis_kelamin, alamat) VALUES ('$nik', '$nama', '$asal_sekolah', '$tanggal_lahir', '$no_telp', '$jenis_kelamin', '$alamat)";
        ...
        <div class="row align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="card py-4" style="width: 22rem;">
                <div class="card-body text-center">
                    ...
                    <hr>
                    <a href="login.php" class="">Saya sudah Mendaftar</a>
                </div>
            </div>
        </div>
    </div>
